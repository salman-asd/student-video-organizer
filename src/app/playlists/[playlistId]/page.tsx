...
function PersonalPlaylistEditorContent() {
  ...
  const [detailCategoryId, setDetailCategoryId] = React.useState<string | null>(null);
  const [detailTagIds, setDetailTagIds] = React.useState<string[]>([]);
  ...
  React.useEffect(() => {
    ...
    setDetailCategoryId(playlist.categoryId || null);
    setDetailTagIds(playlist.tagIds || []);
  ...
  // Self-heals the playlist's stored total (used by the /playlists card
  ...
  async function handleAddVideo() {
    ...
    try {
      ...
      setNewUrl(""); setNewTitle(""); setNewThumb(""); setNewDescription(""); setNewCategoryId(null); setNewTagIds([]); setMetadataPreview(null); setUrlStatus("idle"); setUrlError(null); setAddOpen(false);
      ...
      <Dialog open={addOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-xl">
          ...
          <div className="space-y-4">
            ...
            <TagCategoryPicker userId={ownerId} categoryId={newCategoryId} tagIds={newTagIds} onCategoryChange={setNewCategoryId} onTagsChange={setNewTagIds} />
      ...
      <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <TagCategoryPicker userId={ownerId} categoryId={detailCategoryId} tagIds={detailTagIds} onCategoryChange={setDetailCategoryId} onTagsChange={setDetailTagIds} />
          </div>
          <DialogFooter>
        ...
        <DialogContent>
          ...
          {editing && (
            <div className="space-y-3">
              ...
              <TagCategoryPicker userId={ownerId} categoryId={editing.categoryId} tagIds={editing.tagIds || []} onCategoryChange={(value) => setEditing({ ...editing, categoryId: value })} onTagsChange={(value) => setEditing({ ...editing, tagIds: value })} />
            </div>
          )}
          <DialogFooter>
