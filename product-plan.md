...
- Default categories should be visible immediately
- Users can add their own custom categories/subtopics when needed.

Development: Coding, web development, data science, mobile apps, and programming languages.Business: Management, entrepreneurship, strategy, sales, and operations.Finance & Accounting: Accounting, bookkeeping, financial modeling, and corporate finance.IT & Software: Network security, hardware, operating systems, and IT certifications.Office Productivity: Microsoft Office tools (Excel, PowerPoint, Word) and Google Workspace.Personal Development: Leadership, personal transformation, career growth, and mental health.Design: Graphic design, web design, user experience (UX), and 3D modeling.Marketing: Digital marketing, SEO, social media, and advertising.Lifestyle: Arts and crafts, food and beverage, pet care, gaming, and travel.Photography & Video: Digital photography, video design, and commercial photography.Health & Fitness: Fitness, yoga, nutrition, and mental health.Music: Instruments, music production, and vocals.Teaching & Academics: Math, science, social sciences, humanities, and test prep.
